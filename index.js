...
${GAMES_JSON.length} ${GAMES_JSON.length == 1 ? "game" : "games"}. Currently, 
${numOfUnfundedGames.length} ${numOfUnfundedGames.length == 1 ? "game remains" : "games remain"} unfunded.
We need your help to fund these amazing games!`

// create a new DOM element containing the template string and append it to the description container
const statDisplay = document.createElement("p");
statDisplay.innerHTML = `${displayStr}`
descriptionContainer.appendChild(statDisplay);
